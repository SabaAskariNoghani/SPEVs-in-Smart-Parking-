function plot_data_v_small(P_charg, P_discharg, P_c, P_grid, P_solar,P_solar_spv,P_cspv, E,...
    num,Emin,Emax,time_length)

time_slots = 1:time_length;
...
for i = num:num
    ...
    stairs(time_slots, Emax*ones(1,time_slots(end)),'LineWidth', 1,'Color', 'k','LineStyle', '--');hold on
    stairs(time_slots, Emin*ones(1,time_slots(end)),'LineWidth', 1,'Color', 'k','LineStyle', '--');

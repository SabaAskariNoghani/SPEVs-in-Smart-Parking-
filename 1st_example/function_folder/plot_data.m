function plot_data(P_charg, P_discharg, P_c, P_grid, P_solar,P_solar_spv,P_cspv, E, N, H,...
...
hold on;
stairs(time_slots, P_solar, 'LineWidth', 1.5, 'DisplayName', 'P_solar','LineStyle', '-','Color', mild_green);
...
for i = num:num
    ...
    figure('Position', [20 20 820 220]); % Adjust the width and height as needed
    stairs(time_slots, EE,'LineWidth', 1.5,'Color', color);hold on
    stairs(time_slots, Emax*5*ones(1,H),'LineWidth', 1,'Color', 'k','LineStyle', '--');hold on
    stairs(time_slots, Emin*ones(1,H),'LineWidth', 1,'Color', 'k','LineStyle', '--');
    ...
    stairs(time_slots, P_solar_spv(i,:)','LineWidth', 1.5,'Color','g'); hold on
